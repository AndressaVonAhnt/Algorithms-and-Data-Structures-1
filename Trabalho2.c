...
Reads input, processes the heap, and prints the final result.
====================
*/
int main( void ) {
    int classesSize = 3, extraStudents = 2;
    
    int **classes = ( int ** ) malloc( classesSize * sizeof( int * ) );
    int *classesColSize = ( int * ) malloc( classesSize * sizeof( int ) );
    
    printf( "Enter the pass and total values for each class:\n" );
    for ( int i = 0; i < classesSize; i++ ) {
